...
import com.afunx.rxjava4androiddemos.samples.observable.Filtering.Filter;
import com.afunx.rxjava4androiddemos.samples.observable.Filtering.First;
import com.afunx.rxjava4androiddemos.samples.observable.Filtering.IgnoreElements;
...
public class SampleManager {
    ...
    private void testFilter() {
        Log.d(TAG, "test observable.Filtering.Filter");
        Filter.get().test0();
    }

    private void testFirst() {
        Log.d(TAG, "test observable.Filtering.First");
        First.get().test0();
    }

    private void testIgnoreElements() {
        Log.d(TAG, "test observable.Filtering.IgnoreElements");
        IgnoreElements.get().test0();
    }

    private void testLast() {
        Log.d(TAG, "test observable.Filtering.Last");
        Last.get().test0();
    }
